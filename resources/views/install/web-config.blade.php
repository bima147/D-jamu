...
<html>
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('css/setup-web.css') }}">
    </head>
    <body>
                    ...
                    <div class="col-md-9 register-right">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                @endif
                                <form action="{{ action('Admin\WebController@store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row register-form">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input type="text" minlength="10" maxlength="13" class="form-control" placeholder="Nomer Whatsapp" name="whatsapp"/>
