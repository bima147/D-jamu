...
<body>
        ...
        ***********************************-->
        <div class="nav-header">
            <div class="brand-logo">
                <a href="index.html">
                    <b class="logo-abbr"><img src="{{ asset('backend/images/logo.png') }}" alt="{{ $web->nama_web }}"> </b>
                    <span class="logo-compact"><img src="{{ asset('backend/images/logo-compact.png') }}" alt="{{ $web->nama_web }}"></span>
                    <span class="brand-title">
                        <img src="{{ asset('backend/images/logo-text.png') }}" alt="{{ $web->nama_web }}">
                    </span>
                </a>
            </div>
        </div>
                    ...
                    <ul class="clearfix">
                        <li class="icons dropdown">
                            <div class="user-img c-pointer position-relative"   data-toggle="dropdown">
                                ...
                                <img src="storage/img/avatar/{{ Auth::user()->avatar }}" height="40" width="40" alt="">
                            </div>
        ...
        <div class="nk-sidebar">           
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    <li class="nav-label"><b>Halo, {{ Auth::user()->name }}</b></li>
    ...
    ***********************************-->
    ...
    <script src="{{ asset('backend/plugins/sweetalert/js/sweetalert.min.js') }}"></script>
    <script src="{{ asset('backend/plugins/sweetalert/js/sweetalert.init.js') }}"></script>
