                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-validation">
                                    <form action="{{ action('Admin\JumboSliderController@update', $jumboslider->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input id="judul" name="judul" type="text" class="form-control" placeholder="Masukkan judul jumbo slider" required="on" maxlength="20" value="{{ $jumboslider->judul }}"> 
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <textarea name="isi" id="isi" cols="30" rows="5" class="form-control" placeholder="Masukkan isi jumbo slider" required="on" maxlength="200">{{ $jumboslider->isi }}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input id="tulisan_link" name="tulisan_link" type="text" class="form-control" placeholder="Masukkan tulisan untuk di tombol jumbo slider" required="on" value="{{ $jumboslider->tulisan_link }}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input id="link" name="link" type="text" class="form-control" placeholder="Masukkan link jumbo slider" required="on" value="{{ $jumboslider->link }}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
